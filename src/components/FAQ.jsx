...
let questions = [
  ...
  },
  {
    ...
    answer: <p>Sadly we're unable to allow under-18s to attend Porticode, but keep following <a href='https://www.facebook.com/UCLTechSoc/' target='_blank'>TechSoc on our social media pages</a>, because we'll be running an event for young people in early 2017.</p>
  },
  {
